...
class D3D12Presenter final : public Presenter {
 ...
 private:
  ...
  struct PaintContext {
    ...
    bool SwapChainAllowsTearing() const {
      return (swap_chain_flags & DXGI_SWAP_CHAIN_FLAG_ALLOW_TEARING) != 0;
    }
    bool HasFrameLatencyWaitableObject() const { return swap_chain_latency_waitable_object != nullptr; }
    ...
    HANDLE swap_chain_latency_waitable_object = nullptr;
    UINT swap_chain_maximum_frame_latency = 0;
